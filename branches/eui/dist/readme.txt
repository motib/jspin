...
Click on the Desktop icon to run.

For other systems, download the zip archive and open
in a clean directory.
Download the Erigone model checker and copy erigone.exe
to the directory where you installed EUI.
Run by:
  javaw -jar EUI.jar
