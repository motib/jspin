...
class RunSpin {
  ...
  void run(JTextArea area, EUI.FilterTypes filtering, String command, String parameters) {
  ...
  void runAndWait(JTextArea area, EUI.FilterTypes filtering, String command, String parameters) {
