...
//    private JButton toolSpider = new JButton(Config.Spider);
    ...
    private void initMenus() {
        ...
        initMenuItem(menuDisplay, menuItemTraceOptions, Config.TraceOptionsMN, Config.TraceOptionsAC);
        menuDisplay.addSeparator();
        initMenuItem(menuDisplay, menuItemMax, Config.MaxMN, Config.MaxAC);
        menuDisplay.addSeparator();
        initMenuItem(menuDisplay, menuItemSaveSpin, Config.SaveSpinMN, Config.SaveSpinAC);
